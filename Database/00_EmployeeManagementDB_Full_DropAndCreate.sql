/*****************************************************************************************
 * EMPLOYEE MANAGEMENT SYSTEM - COMPLETE DATABASE DROP & CREATE SCRIPT
 * Database:    EmployeeManagementDB
 * Script Type: ENTIRE DATABASE DROP & RECREATE WITH ALL OBJECTS & SEED DATA
 * Generated:   2026-09-01 14:54:43
 * Target RDBMS:Microsoft SQL Server 2019 / 2022 / Azure SQL
 * 
 * Content Summary:
 *   1. Database Creation (DROP IF EXISTS & CREATE DATABASE)
 *   2. Schema & Tables DDL (21 Tables with PK, FK, Checks, Defaults, Uniques)
 *   3. Stored Procedures DDL (52 Stored Procedures)
 *   4. Master Reference & Initial Seed Data
 *   5. Verification Checks & Object Summary
 *****************************************************************************************/
...
-- ===============================================================================
-- STEP 1: DROP DATABASE IF EXISTS & CREATE DATABASE
-- ===============================================================================
IF EXISTS (SELECT name FROM sys.databases WHERE name = N'EmployeeManagementDB')
BEGIN
    PRINT 'Terminating active connections and dropping existing database EmployeeManagementDB...';
    ALTER DATABASE [EmployeeManagementDB] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE [EmployeeManagementDB];
END
GO

PRINT 'Creating database EmployeeManagementDB...';
...
-- ===============================================================================
-- STEP 2: CREATE TABLES, KEYS, AND CONSTRAINTS
-- ===============================================================================
...
-- ===============================================================================
-- STEP 3: CREATE STORED PROCEDURES (52 Procedures)
-- ===============================================================================
...
-- ===============================================================================
-- STEP 4: INSERT MASTER & INITIAL SEED DATA
-- ===============================================================================
SET NOCOUNT ON;
GO

-- Data: [dbo].[M_Role] (4 rows)
...
-- Data: [dbo].[M_Designation] (10 rows)
...
-- Data: [dbo].[M_OfficeBranch] (4 rows)
...
-- Data: [dbo].[M_SalaryMaster] (4 rows)
...
-- Data: [dbo].[T_LeaveRequest] (8 rows)
...
-- Data: [dbo].[T_Announcement] (3 rows)
...
-- Data: [dbo].[T_SalaryAdvance] (1 rows)
...
-- Data: [dbo].[T_EmployeeDocument] (5 rows)
...
-- ===============================================================================
PRINT '-------------------------------------------------------';
PRINT 'EmployeeManagementDB successfully created and seeded!';
PRINT '-------------------------------------------------------';
SELECT 
    t.name AS [TableName],
    p.rows AS [RowCount]
